...
Multi-platform client for connecting to an [ejunz-node](https://github.com/ejunz-dev/ejunz-node) **Edge** server, managing remote nodes, and controlling Zigbee devices.
